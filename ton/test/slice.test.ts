...
describe('Slice', () => {
    ...
    describe('#skipDict()', () => {
        ...
        it('should throw error on overflow', () => {
            const result1 = () => new Cell().parse().skipDict()
            const result2 = () => new Cell({ bits: [ 1 ] }).parse().skipDict()
    ...
    describe('#loadDict(), #preloadDict()', () => {
        ...
        it('should throw error on overflow', () => {
            const result1 = () => new Cell().parse().loadDict(16)
            const result2 = () => new Cell().parse().preloadDict(16)
            const result3 = () => new Cell({ bits: [ 1 ] }).parse().loadDict(16)
            const result4 = () => new Cell({ bits: [ 1 ] }).parse().preloadDict(16)
